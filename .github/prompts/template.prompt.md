너의 목표는 Django 웹 애플리케이션을 위한 기본 템플릿을 작성하는 것입니다. 이 템플릿은 Bootstrap 5를 사용하여 스타일링되어야 하며, Django의 템플릿 언어를 사용하여 동적으로 콘텐츠를 렌더링할 수 있어야 합니다. 아래의 요구사항을 충족하는 템플릿을 작성하세요.
